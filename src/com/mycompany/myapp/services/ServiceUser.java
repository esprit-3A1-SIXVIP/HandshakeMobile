...
public class ServiceUser {
   ...
   public ArrayList<String> parseTest(String jsonText){
       System.out.println(jsonText);
            ...
            System.out.println("users:"+tasksListJson);
    ...
    /*
     ...
     {
          ArrayList<String> a = new ArrayList<>();
         String url = Statics. GET_URL +  "?evenementId=" +id ;
         req.setUrl(url);
        ...
        req.addResponseListener(new ActionListener<NetworkEvent>() {
          ...
          ArrayList<String>  a= parseTest(new String(req.getResponseData()));
     ...
     return a;
       ...
       public ArrayList<User> getParticipants(int id){
        String url = Statics. GET_URL +  "?evenementId=" +id ;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new com.codename1.ui.events.ActionListener<NetworkEvent>() {
       ...
       public boolean verification(int id, int evenementId)
       {
           boolean a= false;
           for(User u:ServiceUser.getInstance().getParticipants(evenementId)){
               if(u.getId()==id)
               {
                    a=true;
