...
public class ShakeHub {
    ...
    public void start() {
        ...
        Form hi = new Form("ShakeHub", BoxLayout.y());
        Image img;
        try {
        ...
        TextField login = new TextField("", "Entrez votre login:");
        TextField password = new TextField("", "Entrez votre password:");
        login.setText("malek.taktak@esprit.tn");
        ...
        hi.addAll(l1, login, l2, password, btn1);
