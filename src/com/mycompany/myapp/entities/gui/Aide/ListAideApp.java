 ...
 * @author wajih
 */
public class ListAideApp extends Form{
        Form current;

        public ListAideApp(User u) {
        setTitle("Liste des Aides Approuvé");
          ...
          Container co;
             ...
             add(new InfiniteProgress());
                ...
                Display.getInstance().scheduleBackgroundTask(()-> {
                    ...
                    aides=sa.getAllAides();
                             for (Aide fi : aides) {
                      if(fi.getStatutAide()==1){
                            MultiButton m = new MultiButton();
                            m.setTextLine1("ID : "+String.valueOf(fi.getAideId()));
                            m.setTextLine2("Categorie : "+fi.getCategorieAide());
