 ...
 * @author wajih
 */
public class MyBen extends Form{
        Form current;

        public MyBen(User u) {
        setTitle("Mes Beneficiaires");
          ...
          Container co=new Container(BoxLayout.xCenter());;
            ...
            public void actionPerformed(ActionEvent evt) {               
                ...
                Beneficiaire t = new Beneficiaire(fi.getBeneficiaireId());
                        if( ServiceBeneficiaire.getInstance().deleteBen(t)){
                            {
